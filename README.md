...
**Budget Buddy** is a budget web application where users can create accounts, add categories and add expenses to these categories in order to follow how much money spent on each category.
...
```sh
  cd <desired-folder>
  git clone https://github.com/mertkantaroglu/Budget-Buddy.git
```
